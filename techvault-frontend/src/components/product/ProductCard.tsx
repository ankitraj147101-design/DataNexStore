  ...
  return (
    <div className="group relative bg-white border border-slate-200 hover:border-sky-400 rounded-2xl sm:rounded-3xl p-2.5 sm:p-4 flex flex-col justify-between transition-all duration-300 shadow-2xs hover:shadow-lg hover:-translate-y-0.5">
      ...
      <Link
        ...
        className="block relative overflow-hidden rounded-xl sm:rounded-2xl bg-slate-50/70 p-2 sm:p-4 aspect-square mb-2 sm:mb-3 group/img border border-slate-100 flex items-center justify-center"
      >
        <img
          src={primaryImage}
          alt={product.name}
